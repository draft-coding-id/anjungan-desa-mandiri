...
<div>
    ...
    <table class="data-table">
        ...
        <tr>
            ...
            <td>:</td>
            <td>{{ $surat->isi_surat['tempat_lahir'] ?? '[Tempat Lahir]' }},
                {{ $surat->isi_surat['tanggal_lahir'] ?? '[Tanggal Lahir]' }}
            </td>
        </tr>
        <tr>
            <td>4. Umur</td>
            <td>:</td>
            <td>{{ $surat->isi_surat['usia'] ?? '[Usia]' }} Tahun</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>:</td>
            <td>{{ $surat->isi_surat['alamat'] ?? '[Alamat]' }} RT {{ $surat->isi_surat['rt'] ?? '[RT]' }} RW
                {{ $surat->isi_surat['rw'] ?? '[RW]' }} Desa {{ $surat->isi_surat['desa'] ?? 'Rawapanjang' }}, Kecamatan
                {{ $surat->isi_surat['kecamatan'] ?? 'Bojonggede' }}, Kabupaten Bogor
            </td>
        </tr>
        <tr>
