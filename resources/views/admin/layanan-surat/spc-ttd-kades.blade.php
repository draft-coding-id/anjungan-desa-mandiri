        ...
        <table class="data-table">
            ...
            <tr>
                ...
                <td>{{ $surat->isi_surat['tempat_lahir'] }},
                    {{ \Carbon\Carbon::parse($surat->isi_surat['tanggal_lahir'])->format('d-m-Y') }}
                </td>
            </tr>
            <tr>
                <td>4. Pekerjaan</td>
            ...
            <tr>
                ...
                <td>{{ $surat->isi_surat['alamat'] }}, Desa {{ $surat->isi_surat['desa'] }}, Kecamatan
                    {{ $surat->isi_surat['kecamatan'] }}, Kabupaten Bogor
                </td>
            </tr>
        </table>
        ...
        <table class="data-table">
            ...
            <tr>
                ...
                <td>{{ $surat->isi_surat['tempat_lahir_pasangan'] }},
                    {{ \Carbon\Carbon::parse($surat->isi_surat['tanggal_lahir_pasangan'])->format('d-m-Y') }}
                </td>
            </tr>
            <tr>
                <td>10. Pekerjaan</td>
            ...
            <tr>
                ...
                <td>{{ $surat->isi_surat['alamat_pasangan'] }}, Desa {{ $surat->isi_surat['desa_pasangan'] }}, Kecamatan
                    {{ $surat->isi_surat['kecamatan_pasangan'] }}, Kabupaten Bogor
                </td>
            </tr>
        </table>
        <table class="data-table">
