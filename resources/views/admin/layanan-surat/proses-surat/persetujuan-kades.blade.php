...
<body>
    ...
    <div class="main-content">
        ...
        <div class="content">
            <div class="mt-4">
                <h3>Surat Keperluan Domisili</h3>
                <h3>{{$surat->isi_surat['nama_lengkap']}}</h3>
                <p>diajukan pada {{ $surat->created_at->translatedFormat('d F Y') }}</p>
                <br>
                <p>Surat telah diverlifikasi oleh Administrator</p>
                <p>Mohon lakukan tanda tangan secara digital apabila surat yang warga ajukan ini telah sesuai ketentuan.
                </p>
            </div>
