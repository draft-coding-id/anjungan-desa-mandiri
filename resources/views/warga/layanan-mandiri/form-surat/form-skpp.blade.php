...
<x-info-box :message="'Silakan lengkapi data berikut untuk pembuatan Surat Keterangan Penduduk.'" />

<form action="{{ route('submitForm') }}" method="POST" enctype="multipart/form-data">
  @csrf
  <input type="hidden" name="warga_id" value="{{ $warga->id }}">
  <input type="hidden" name="jenis_surat" value="SKPP">
  ...
  <table class="form-table">
    ...
    <tr>
      <td>Status Pernikahan <span class="required">*</span></td>
      <td>:</td>
      <td>
  ...
  <table class="form-table">
    <tr>
      <td>Nama Kepala Keluarga <span class="required">*</span></td>
      <td>:</td>
      <td>
        <input type="text" name="nama_kepala_keluarga" required>
      </td>
    </tr>
    <tr>
      <td>Alasan Pindah <span class="required">*</span></td>
      <td>:</td>
      <td>
    ...
    <tr>
      <td>Jumlah Keluarga yang Pindah <span class="required">*</span></td>
      <td>:</td>
      <td>
        <input type="number" name="jumlah_keluarga_pindah" required>
      </td>
    </tr>
