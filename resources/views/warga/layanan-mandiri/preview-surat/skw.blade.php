...
<table class="content">
    ...
    <tr>
        ...
        <td>:</td>
        <td>{{ $proses_surat['wali_nama'] }}</td>
    </tr>
    <tr>
        <td>2. NIK / No. KTP</td>
        <td>:</td>
        <td>{{ $proses_surat['wali_nik'] }}</td>
    </tr>
    <tr>
        <td>3. Tempat / Tanggal Lahir</td>
        <td>:</td>
        <td>{{ $proses_surat['wali_tempat_lahir'] }}, {{ \Carbon\Carbon::parse($proses_surat['wali_tanggal_lahir'])->format('d-m-Y') }}</td>
    </tr>
    <tr>
        <td>4. Alamat/Tempat Tinggal</td>
        <td>:</td>
        <td>{{ $proses_surat['wali_alamat'] }}</td>
    </tr>
    <tr>
        <td>5. Pekerjaan</td>
        <td>:</td>
        <td>{{ $proses_surat['wali_pekerjaan'] }}</td>
    </tr>
</table>
...
<table class="content">
    ...
    <tr>
        <td>3. Tempat / Tanggal Lahir</td>
        <td>:</td>
        <td>{{ $proses_surat['tempat_lahir'] }}, {{ \Carbon\Carbon::parse($proses_surat['tanggal_lahir'])->format('d-m-Y') }}</td>
    </tr>
    <tr>
...
<p>Hubungan wali adalah sebagai: {{ $proses_surat['hubungan_keluarga'] }}</p>
